...
from Levin.core.utils import Singleton
import os
...
# Define private keys
galadriel_private_keys = []
if 'PRIVATE_KEY_GALADRIEL' in os.environ:
    galadriel_private_keys.append(os.environ['PRIVATE_KEY_GALADRIEL'])

localhost_private_keys = []
if 'PRIVATE_KEY_LOCALHOST' in os.environ:
    localhost_private_keys.append(os.environ['PRIVATE_KEY_LOCALHOST'])

# Hardhat configuration (Galadriel configuration)
galadriel_config = {
    'solidity': {
        'version': '0.8.20',
        'settings': {
    ...
    'networks': {
        'galadriel': {
            ...
            'accounts': galadriel_private_keys
        },
        'hardhat': {
            'chainId': 1337
        },
        'localhost': {
            ...
            'accounts': localhost_private_keys
        }
    }
}

# Export the config as a dictionary
config = galadriel_config
